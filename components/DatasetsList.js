          ...
          <div className="ui page grid">
            <div className="row">
              <div className="column">
                ...
                <h1 className="ui header">VoID Dataset Descriptions</h1>
...
DatasetsList.contextTypes = {
    getUser: React.PropTypes.func
};
DatasetsList = connectToStores(DatasetsList, [DatasetStore], function (context, props) {
    return {
